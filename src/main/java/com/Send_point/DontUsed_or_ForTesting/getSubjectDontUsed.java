package com.Send_point.DontUsed_or_ForTesting;
...
public class getSubjectDontUsed {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        InputStream in = getSubjectDontUsed.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void main2() throws IOException, GeneralSecurityException {
        ...
        for (Sheet sheet : sheets) {
            ...
            ValueRange response = service.spreadsheets().values()
                    .get(spreadsheetId, sheet.getProperties().getTitle().toString()+"!B1:E1")
                    .execute();
